	...
	public void show(Stage primaryStage) {
		...
		questionListView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
			...
			if (newVal != null) {
				...
				removeQuestionButton.setDisable(!newVal.getUser().equals(UserLoginPage.userNamePublic)); // Enable
																											// Remove
																											// Question
																											// button if
																											// posted by
																											...
																											// current
																											// user
				updateQuestionButton.setDisable(!newVal.getUser().equals(UserLoginPage.userNamePublic)); // Enable
																											// Update
																											// Question
																											// button if
																											// posted by
		...
		answersListView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
			if (newVal != null) {
				removeAnswerButton.setDisable(newVal == null || !newVal.getUser().equals(UserLoginPage.userNamePublic)); // Enable
				// Remove
				// Answer
				// button
				// if
				...
				// current
				// user
				updateAnswerButton.setDisable(newVal == null || !newVal.getUser().equals(UserLoginPage.userNamePublic)); // Enable
				// Update
				// Answer
				// button
				// if
		...
		removeQuestionButton.setOnAction(e -> {
			...
			if (selectedQuestion != null && selectedQuestion.getUser().equals(UserLoginPage.userNamePublic)) {
				...
				answers.removeAnswers(selectedQuestion.getQuestionId(), UserLoginPage.userNamePublic); // Also remove
																										// associated
																										// answers
			}
		});
